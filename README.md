...
if you want to train this model with your own datasets, you need to reset the name of each tasks for args.tasks, the task ID was generate automatically based on the sequence, the args.dataset_num means the number of these tasks then you need to set seg_num and det_num to tell model which task represents segmentation and detection, represently.
